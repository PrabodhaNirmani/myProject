    ...
    <div class="container" xmlns="http://www.w3.org/1999/html">
        ...
        <form action="post">
            ...
            <ul class="collapsible" data-collapsible="accordion">
                ...
                <li>
                    <div class="collapsible-header"><i class="material-icons">stars</i>Siblings Studying in the same
                        School
                    </div>
                    <div class="collapsible-body">
                        <div class="container">
                ...
                <li>
                    ...
                    <div class="collapsible-body">
                        <div class="container">
                            <p>
                                I hereby declare that my child is not attending any government school; government
                                approved private school or any other school at present for his/her studies.
                                I also declare that the details furnished above are true and correct and I agree further
                                to submit satisfactory evidence relating to my permanent resident and other information
                                indicated here
                                I am also aware that my application rejected if any information furnished by me is found
                                to be false/forged.
                                If it is revealed after the admission of my child that the information furnished is
                                false/forged
                                I agree to remove my child from the school and admit him/her to another school in the
                                area nominated by the Department of Education.
                            </p>
